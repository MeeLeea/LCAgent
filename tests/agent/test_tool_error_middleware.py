"""ToolExecutionErrorMiddleware 测试 - 验证工具异常转换为 LLM 可读的错误 ToolMessage。
...
运行：
  pytest tests/agent/test_tool_error_middleware.py -v
"""
...
from agent.tool_error_middleware import ToolExecutionErrorMiddleware
...
class TestErrorFormatting:
    ...
    def test_mentions_exception_type_and_message(self):
        """内容点名异常类型 + 原始错误信息。"""
        mw = ToolExecutionErrorMiddleware()
