...
function loadServerConfig() {
    ...
    try {
        var cfgPath = resolve(__dirname, '..', 'config', 'server_config.json');
        var raw = readFileSync(cfgPath, 'utf-8');
...
var apiTarget = "http://".concat(serverConfig.host, ":").concat(serverConfig.port);
